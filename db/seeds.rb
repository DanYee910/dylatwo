...
locations = [
  ...
  {name: 'Large House',district:'Suburbs',fastmin:0, fastmax:1, medmin:0, medmax:3, slowmin:0, slowmax:6, flavortext:'So many rooms, you only need to check a few.',imgtag:'smallhouse.jpg'},
  {name: 'Mansion',district:'Suburbs',fastmin:0, fastmax:1, medmin:0, medmax:2, slowmin:0, slowmax:4, flavortext:'The owner locked up before leaving, few zombies are around.',imgtag:'smallhouse.jpg'},
  ...
  {name:'Movie theater',district:'Downtown',fastmin:1, fastmax:3, medmin:2, medmax:5, slowmin:2, slowmax:8, flavortext:'It\'s dark, too dangerous?',imgtag:'firestation.jpg'},
