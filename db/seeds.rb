...
locations = [
  ...
  {name: 'City Hall', district:'Downtown',fastmin:1, fastmax:2, medmin:3, medmax:5, slowmin:5, slowmax:8, flavortext:'Used to be an emergency shelter, it\'s chaos.',imgtag:'museum.jpg'},
  {name: 'Super mall', district:'Downtown',fastmin:2, fastmax:3, medmin:3, medmax:5, slowmin:5, slowmax:7, flavortext:'I doubt anything is left, looks like everyone ran through here',imgtag:'mall.jpg'},
  {name: 'Superstore', district:'Downtown',fastmin:0, fastmax:3, medmin:3, medmax:5, slowmin:5, slowmax:8, flavortext:'Overrun in a hurry, there are still things on the shelves.',imgtag:'bakery.jpg'},
  ...
  {name: 'Apartment building',district:'Suburbs',fastmin:0, fastmax:3, medmin:2, medmax:5, slowmin:4, slowmax:9, flavortext:'The tenants are still here, and they\'re hungry.',imgtag:'medbuilding.jpg'},
  ...
  {name: 'Large House',district:'Suburbs',fastmin:0, fastmax:1, medmin:0, medmax:3, slowmin:0, slowmax:6, flavortext:'So many rooms, you only need to check a few.',imgtag:'largehouse.jpg'},
  {name: 'Mansion',district:'Suburbs',fastmin:0, fastmax:1, medmin:0, medmax:2, slowmin:0, slowmax:4, flavortext:'The owner locked up before leaving, few zombies are around.',imgtag:'museum.jpg'},
  ...
  {name: 'Urgent Care Clinic',district:'Suburbs',fastmin:1, fastmax:3, medmin:3, medmax:6, slowmin:5, slowmax:9, flavortext:'Everyone who was sick came here, and never left.',imgtag:'medbuilding.jpg'},
  ...
  {name:'Gun Store',district:'Suburbs',fastmin:1, fastmax:2, medmin:2, medmax:3, slowmin:3, slowmax:5, flavortext:'One of the first places looted, anything left?',imgtag:'candleshop.jpg'},
  {name:'Bakery',district:'Suburbs',fastmin:0, fastmax:1, medmin:1, medmax:3, slowmin:2, slowmax:5, flavortext:'the smell of baked bread used to linger here',imgtag:'bakery.jpg'},
  ...
  {name:'Movie theater',district:'Downtown',fastmin:1, fastmax:3, medmin:2, medmax:5, slowmin:2, slowmax:8, flavortext:'It\'s dark, too dangerous?',imgtag:'mall.jpg'},
  {name:'Casino Resort',district:'Wharf',fastmin:1, fastmax:2, medmin:1, medmax:5, slowmin:2, slowmax:9, flavortext:'Everyone left in a hurry, there are chips everywhere.',imgtag:'restaurant.jpg'},
  {name:'Fine Art Museum',district:'Downtown',fastmin:0, fastmax:1, medmin:1, medmax:4, slowmin:2, slowmax:6, flavortext:'Blood stains the walls, but you see nothing.',imgtag:'museum.jpg'},
  {name:'Convention Center',district:'Downtown',fastmin:0, fastmax:1, medmin:2, medmax:5, slowmin:4, slowmax:9, flavortext:'Another destroyed emergency shelter',imgtag:'museum.jpg'},
  {name:'Church',district:'Downtown',fastmin:1, fastmax:2, medmin:2, medmax:5, slowmin:4, slowmax:7, flavortext:'There was no salvation to be found here',imgtag:'museum.jpg'},
